...
public class RewardAds : MonoBehaviour, IUnityAdsLoadListener, IUnityAdsShowListener
{
    ...
    public void OnUnityAdsShowComplete(string adUnitId, UnityAdsShowCompletionState showCompletionState)
    {
        if (adUnitId.Equals(_adUnitId) && showCompletionState.Equals(UnityAdsShowCompletionState.COMPLETED))
        {
            ...
            //GetComponentInParent<AdManager>().GetAdStatus().text = "You get a reward!";
            Hexagon.Instance.Pause = false;
            // Load another ad:
            Advertisement.Load(_adUnitId, this);
            StartCoroutine(Hexagon.Instance.flipBoard());
        }
    }
